...
import { listJobByCategory } from "../Category/CategoryActions";
import { CATEGORY_PAGE } from "../../routes/routes";
...
const CategoryJob = () => {
  ...
  const jobListByCategory = useSelector((state) => state.jobListByCategory);
  const { loading, jobs } = jobListByCategory;
