...
export const CATEGORY_JOB_LIST_REQUEST = "CATEGORY_JOB_LIST_REQUEST";
export const CATEGORY_JOB_LIST_SUCCESS = "CATEGORY_JOB_LIST_SUCCESS";
export const CATEGORY_JOB_LIST_FAIL = "CATEGORY_JOB_LIST_FAIL";
